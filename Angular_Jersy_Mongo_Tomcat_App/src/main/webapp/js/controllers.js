...
qaApp.controller('SignupController', function($rootScope, $scope,
		QAScriptFactory, $location) {
...
qaApp.controller('LoginController', function($scope, QAScriptFactory, $location) {
	$scope.userInfo = null;
	$scope.login = function() {
		QAScriptFactory.login({
			email : $scope.email,
			password : $scope.passwd
		}, function() {
			$location.path('/home');
...
qaApp.controller('HomeController', function($scope, QAScriptFactory, $location) {
...
qaApp.controller('QAScriptController', function($scope, $rootScope, $timeout,
		$modal, $log, $dialogs, QAScriptFactory) {
	var sheetData = [];
	$(document).ready(
			function() {
				/**
				...
				viewSheet.bind($.wijmo.wijspread.Events.CellChanged, function(
						event, data) {
	...
	$scope.launch = function() {
		...
		dlg = $dialogs.create('/dialogs/howmanyrows.html', 'HowManyRowsCtrl',
				{}, {
					key : false,
					back : 'static'
				});
	...
	$scope.saveScript = function() {
		...
		// console.log(JSON.stringify("save data : " +
	...
	$scope.getSheet = function() {
		...
		QAScriptFactory.getSheetData().success(function(data) {
	...
	function callToService(saveData) {
		...
		QAScriptFactory.postSheetData(saveData).success(function(data) {
			console.log(data);
			$scope.getSheet();
		}).error(function(status) {
			console.log(status);
